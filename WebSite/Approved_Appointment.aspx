<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="Approved_Appointment.aspx.cs" Inherits="Approved_Appointment" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function SaveProj() {
            ...
            $.ajax({
                ...
                url: "Approved_Appointment.aspx/SaveITProject",
        ...
        function getITProj() {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Approved_Appointment.aspx/GetITProjDetails",
                data: "{}",
        ...
        function onsuccessgetITProj(msg) {
            ...
            tbl += "<th style='text-align:left; display:none; white-space:nowrap;'>Visitor ID</th>";
            tbl += "<th style='white-space:nowrap; text-align:left;'>Host Name</th>";
            ...
            tbl += "<th style='text-align:center; white-space:nowrap; display:none;'>Approve</th>";
            ...
            for (var i = 0; i < data.ProjDetails.length; i++) {
                ...
                tbl += "<td style='text-align:left; white-space:nowrap;' id='txtHostName" + i + "'>" + data.ProjDetails[i].Person_To_Visit + "</td>";
                tbl += "<td style='text-align:left; white-space:nowrap;' id='txtdateofVisit" + i + "'>" + data.ProjDetails[i].DateofVisit + "</td>";
                
                // tbl += "<td style='text-align:left; white-space:nowrap;' id='txtCompanyName" + i + "'>" + data.ProjDetails[i].Company_Name + "</td>";
                //tbl += "<td style='text-align:right; white-space:nowrap;' id='txtStatus" + i + "'>" + data.ProjDetails[i].Status + " </td>";
                tbl += "<td style='cursor:Pointer; display:none;' id='txtUpdate' align='center' onclick='return ApproveStatus(" + i + ");'><img src='images/Tick1.png' width='40px' height='40px'></td>";
                tbl += "<td style='cursor:Pointer;' id='txtdelete' align='center' onclick='return DeclineStatus(" + i + ");'><img src='images/Cross3.png' width='45px' height='60px'> </td>";
                tbl += "</tr>";
            }
            tbl += "</tbody>";
            tbl += "</table>";
        ...
        function ApproveStatus(rowNo) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Approved_Appointment.aspx/SendEmail",
                data: "{'rtxt':'" + ProjID + "','status':'Approved'}",
        ...
        //function onsuccessSendEmail(msg) {
        ...
        function onsuccessApprove() {
            alert("Are you sure to Delete this Visitor!"); location.reload();
            //getITProj();
            //Clear();
            return false;
        }
        ...
        function DeclineStatus(rowNo) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Approved_Appointment.aspx/DeclineStatus",
                data: "{'Visitor_ID':'" + ProjID + "'}",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                url: "Approved_Appointment.aspx/SendEmail",
                data: "{'rtxt':'" + ProjID + "','status':'Declined'}",
                success: onsuccessSendEmail,
                error: onretrieveSendEmail
            });
            return false;
        ...
        $(document).ready(function () {
            if ($("span[id$='lblRole']").text().trim() != "Admin") {
                $("#fldITProjDetails select").attr("disabled", true);
                $("#fldITProjDetails select").attr("disabled", true);
            }
