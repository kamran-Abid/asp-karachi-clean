<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sites.aspx.cs" Inherits="Setting_Forms_Sites" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="Sites.aspx.cs" Inherits="Setting_FormsSites" %>
                ...
                <fieldset>
                    ...
                    <table id="tblPlaces" style="font-family: Calibri; font-size: 11pt; width: 100%;">
                        <tr>
                            ...
                            <td style="width: 600px;">
                                <asp:TextBox ID="txtPlaceName" Width="95%" class="alphanumeric req" placeholder="Enter Lane Name" runat="server" BackColor="White"></asp:TextBox>
                            </td>
