<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="VisitArea.aspx.cs" Inherits="VisitArea" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                   ...
                   <legend>Add/Modified Department/Unit</legend>
                    ...
                    <tr>
                        ...
                        <td   style="width: 600px;">
                            <asp:TextBox ID="txtDepartmentName" Width="95%" placeholder="Enter Department Name"  class="alphanumeric" runat="server" BackColor="White"></asp:TextBox>
                        </td>
                        ...
                        <td align="left">
                            <asp:Button ID="btnSave" Text="Add" CssClass="btn" OnClientClick="return SaveDepartment1();" runat="server" />
     ...
     <script type="text/javascript" language="javascript">
         ...
         function SaveDepartment1() {
             ...
             var VisitAreaName = $("input[id$='txtDepartmentName']").val().trim();
             ...
             $.ajax({
                 ...
                 url: "Settingwebmethods.aspx/SaveDepartment1",
                 data: "{'VisitAreaName':'" + VisitAreaName + "'}",
         ...
         function getDepartment() {
             $.ajax({
                 type: "POST",
                 contentType: "application/json; charset=utf-8",
                 url: "Settingwebmethods.aspx/getDepartmentDetail1",
                 data: "{}",
         ...
         function onsuccessgetDepartment(msg) {
             ...
             for (var i = 0; i < data.GetDepartmentDetail.length; i++) {
                 ...
                 tbl += "<td style='text-align:right; white-space:nowrap; display:none;' id='txtID" + i + "'>" + data.GetDepartmentDetail[i].VisitArea_ID + "</td>";

                 tbl += "<td style='text-align:left; white-space:nowrap;' id='txtDepartmentName" + i + "'>" + data.GetDepartmentDetail[i].VisitAreaName + "</td>";
         ...
         function DeleteDepartmentRecord(rowNo) {
             ...
             var VisitArea_ID = $("#txtID" + rowNo).html();

             if (confirm("Are you sure you wish to delete this Record?")) {
                 $.ajax({
                     type: "POST",
                     contentType: "application/json; charset=utf-8",
                     url: "Settingwebmethods.aspx/DeleteDepartment1",
                     data: "{'VisitArea_ID':'" + VisitArea_ID + "'}",
         ...
         function UpdateDepartment() {
             var VisitArea_ID = $("input[id$='txtID']").val();

             var VisitAreaName = $("input[id$='txtDepartmentName']").val();
             ...
             $.ajax({
                 type: "POST",
                 contentType: "application/json; charset=utf-8",
                 url: "Settingwebmethods.aspx/UpdateDepartment1",
                 data: "{'VisitArea_ID':'" + VisitArea_ID + "','VisitAreaName':'" + VisitAreaName + "'}",
